...
class _TimeRowState extends State<TimeRow> {
  ...
  /// Day marker (like TradingView "18" when date changes)
  Widget _dayMarker(DateTime time, BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final bg = isDark ? const Color(0xFF2A2A2A) : const Color(0xFFE9ECEF);
    ...
    return Container(
      ...
      child: Text(
        // broker-style day marker (e.g. "18")
        '${time.day}',
        style: TextStyle(
          color: fg,
          fontSize: 12,
        ...
        children: [
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              DateTime? _prevTime;
              if (index > 0) {
                _prevTime = _timeCalculator(step, index - 1, dif);
              }

              final isNewDay = _prevTime == null ||
                  _prevTime.year != _time.year ||
                  _prevTime.month != _time.month ||
                  _prevTime.day != _time.day;
              ...
              return Column(
                ...
                children: [
                  ...
                  // Always show time labels, but when the day changes show a bold day marker ("18").
                  isNewDay
                      ? _dayMarker(_time, context)
                      : _hourMinuteText(
