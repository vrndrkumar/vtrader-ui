...
class _DesktopChartState extends State<DesktopChart> {
  ...
  // Wider clamp range improves vertical zoom range.
  double _maxAdditionalVerticalPadding(double maxHeight) => maxHeight * 0.65;
                                  ...
                                  onScale: (delta) {
                                    setState(() {
                                      ...
                                      additionalVerticalPadding = min(
                                          _maxAdditionalVerticalPadding(maxHeight),
                        ...
                        child: Listener(
                          onPointerSignal: (pointerSignal) {
                            if (pointerSignal is PointerScrollEvent) {
                              ...
                              // scroll up  -> zoom in (wider candles)
                              // scroll down-> zoom out (narrower candles)
                              final dy = pointerSignal.scrollDelta.dy;
                              final scale = dy < 0 ? 1.10 : 0.90;
